                    ...
                    <div class="row">
                        @foreach($relatedPosts as $rp)
                            <div class="col-md-4" data-aos="fade-right" data-aos-delay="100">
                                <img src="{{ asset('storage/' . $rp->preview_image) }}" alt="related post" class="post-thumbnail">
                                <p class="post-category">{{ $rp->category->title }}</p>
                                <a href="{{ route('post.show', $rp->id) }}" class="post-permalink media">
                                    <h5 class="post-title">{{ $rp->title }}</h5>
                                </a>
                            </div>
                        @endforeach
                    </div>
